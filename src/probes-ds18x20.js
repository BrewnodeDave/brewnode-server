 ...
 */
 module.exports = [
	...
	{name:"Temp Fermenter", id:'28-ab0e2e346461', prevValue:null, publishTemp:()=>false, compensate:x=>round(x*1.028165066-2.329363108)},
	{name:"Temp Mash",		id:'28-0000069be682', prevValue:null, publishTemp:()=>false, compensate:x=>round(x*1.018340748-1.309362047)},
	{name:"Temp Glycol",	id:'28-0000071f5017', prevValue:null, publishTemp:()=>false, compensate:x=>round(x*1.020492493-1.323124509)},	
